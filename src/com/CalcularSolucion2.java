...
public class CalcularSolucion2 {
    ...
    public String getSolucion(@QueryParam("descripcion") String descripcion, @QueryParam("variable1nombre") String variable1nombre, @QueryParam("variable1rangomin") String variable1rangomin, @QueryParam("variable1rangomax") String variable1rangomax, @QueryParam("variable1unidad") String variable1unidad, @QueryParam("variable1color") String variable1color, @QueryParam("variable2nombre") String variable2nombre, @QueryParam("variable2rangomin") String variable2rangomin, @QueryParam("variable2rangomax") String variable2rangomax, @QueryParam("variable2unidad") String variable2unidad, @QueryParam("variable2color") String variable2color, @QueryParam("variable3nombre") String variable3nombre, @QueryParam("variable3rangomin") String variable3rangomin, @QueryParam("variable3rangomax") String variable3rangomax, @QueryParam("variable3unidad") String variable3unidad, @QueryParam("variable3color") String variable3color, @QueryParam("variable4nombre") String variable4nombre, @QueryParam("variable4rangomin") String variable4rangomin, @QueryParam("variable4rangomax") String variable4rangomax, @QueryParam("variable4unidad") String variable4unidad, @QueryParam("variable4color") String variable4color, @QueryParam("variable5nombre") String variable5nombre, @QueryParam("variable5rangomin") String variable5rangomin, @QueryParam("variable5rangomax") String variable5rangomax, @QueryParam("variable5unidad") String variable5unidad, @QueryParam("variable5color") String variable5color, @QueryParam("variable6nombre") String variable6nombre, @QueryParam("variable6rangomin") String variable6rangomin, @QueryParam("variable6rangomax") String variable6rangomax, @QueryParam("variable6unidad") String variable6unidad, @QueryParam("variable6color") String variable6color, @QueryParam("variable7nombre") String variable7nombre, @QueryParam("variable7rangomin") String variable7rangomin, @QueryParam("variable7rangomax") String variable7rangomax, @QueryParam("variable7unidad") String variable7unidad, @QueryParam("variable7color") String variable7color, @QueryParam("variable8nombre") String variable8nombre, @QueryParam("variable8rangomin") String variable8rangomin, @QueryParam("variable8rangomax") String variable8rangomax, @QueryParam("variable8unidad") String variable8unidad, @QueryParam("variable8color") String variable8color, @QueryParam("variable9nombre") String variable9nombre, @QueryParam("variable9rangomin") String variable9rangomin, @QueryParam("variable9rangomax") String variable9rangomax, @QueryParam("variable9unidad") String variable9unidad, @QueryParam("variable9color") String variable9color, @QueryParam("variable10nombre") String variable10nombre, @QueryParam("variable10rangomin") String variable10rangomin, @QueryParam("variable10rangomax") String variable10rangomax, @QueryParam("variable10unidad") String variable10unidad, @QueryParam("variable10color") String variable10color, @QueryParam("islas") String islas, @QueryParam("iteraciones") String iteraciones, @QueryParam("tipoSolucion") String tipoSolucion, @QueryParam("variablesAct") String variablesAct, @QueryParam("accept") String accept) {    	
    //ARRIBA EN LA FUNCION FALTA RESOLVER SI LA VARIABLE ES CONTINUA O DISCRETA!!!!
   	//TAMBIEN FALTA RESOLVER LA VARIABLE variablesAct
		...
		variable[10][3] = variable10unidad;
    	...
    	*/
		...
		int poblacionTotal = islasInt*100;
		...
		particula1.add(variable1rangomin);
		particula1.add(variable1rangomax);
		particula1.add(variable2rangomin);
		particula1.add(variable2rangomax);
		particula1.add(variable3rangomin);
		particula1.add(variable3rangomax);
		particula1.add(variable4rangomin);
		particula1.add(variable4rangomax);
		particula1.add(variable5rangomin);
		particula1.add(variable5rangomax);
		particula1.add(variable6rangomin);
		particula1.add(variable6rangomax);
		particula1.add(variable7rangomin);
		particula1.add(variable7rangomax);
		particula1.add(variable8rangomin);
		particula1.add(variable8rangomax);
		particula1.add(variable9rangomin);
		particula1.add(variable9rangomax);
		particula1.add(variable10rangomin);
		particula1.add(variable10rangomax);
		...
		*/
    	...
    	return "<body><h1>" + datos + "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</body></h1>";
    }
