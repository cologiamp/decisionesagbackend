...
public class KMeans {
    public KMeansResultado calcular(List<Punto> puntos, Integer k) {
   	...
   	System.out.println("Funcion calcular, puntos: "+puntos);
	...
	System.out.println("Funcion calcular, clusters: "+clusters);
	...
	System.out.println("Funcion preparaClusters, ofv: "+ofv);
	return ofv;
    }
